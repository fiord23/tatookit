...
void display_init (void)
{
    ...
    command(0x23);                     // 0xC2 - osc clock=0xC divide ratio = 0x2

    command(SETMULTIPLEX); // 0xA8 - Multiplex ratio
    command(0x47);                     // 0x1F - 31
  ...
  // disable internal charge pump
    ...
    command(0xFF);                    
           // 0x00
    command(0xBC); // 0xAC - Internal charge pump
    command(0x1E);         
...
{
    const uint8_t PIC1[] = {  0X20,0X04,0X80,0X00,0X48,0X00,
...
0X00,0X00,0X00,0XF0,0XFF,0XFF,0XAA,0X00,0XF0,0X00,0XFF,0XFF,0X00,0X00,0X00,0X00,
...
0X00,0X00,0X00,0X00,0X00,0XFF,0XFF,0X00,0X10,0XF0,0X00,0X00,0X00,0XF0,0X0F,0XF0,
...
0X00,0X00,0XFF,0XFF,0XFF,0XFF,0XFF,0X00,0XBB,0X00,0X00,0X00,0XFF,0X00,0X00,0X00,
...
0X00,0X00,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0X13,0X00,0X00,0X00,0X0F,0X00,0X00,0X00,
...
0XFF,0XFF,0XFF,0XFF,0XFF,0X14,0X00,0XF0,0XFF,0X00,0X00,0X00,0XFF,0XFF,0XFF,0XFF,
